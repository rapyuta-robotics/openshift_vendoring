...
`)
	...
	openshiftForks := sets.NewString(
		...
		"github.com/openshift/github.com/skynetservices/skydns",
		"github.com/openshift/github.com/coreos/etcd",
		"github.com/openshift/github.com/emicklei/go-restful",
		"github.com/golang/glog",
		"github.com/openshift/github.com/cloudflare/cfssl",
		"github.com/openshift/github.com/google/certificate-transparency",
		"github.com/openshift/github.com/RangelReale/osin",
		"github.com/openshift/github.com/google/cadvisor",
	)
	...
	for _, k := range ours {
		if oRev, kRev := originGodeps[k].Rev, k8sGodeps[k].Rev; oRev != kRev {
			...
			if !strings.HasPrefix(k, "github.com/openshift/github.com/") {
				continue
			}

			parts := strings.SplitN(k, "/", 4)
			repo := fmt.Sprintf("github.com/openshift/github.com/%s/%s", parts[1], parts[2])
