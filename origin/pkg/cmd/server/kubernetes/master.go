...
import (
	...
	kctrlmgr "github.com/openshift/kubernetes/cmd/kube-controller-manager/app"
	...
	jobcontroller "github.com/openshift/kubernetes/pkg/controller/job"
	...
	petsetcontroller "github.com/openshift/kubernetes/pkg/controller/petset"
	podautoscalercontroller "github.com/openshift/kubernetes/pkg/controller/podautoscaler"
	"github.com/openshift/kubernetes/pkg/controller/podautoscaler/metrics"
	gccontroller "github.com/openshift/kubernetes/pkg/controller/podgc"
	replicasetcontroller "github.com/openshift/kubernetes/pkg/controller/replicaset"
	...
	attachdetachcontroller "github.com/openshift/kubernetes/pkg/controller/volume/attachdetach"
	persistentvolumecontroller "github.com/openshift/kubernetes/pkg/controller/volume/persistentvolume"
	"github.com/openshift/kubernetes/pkg/master"
	...
	"github.com/openshift/kubernetes/plugin/pkg/scheduler"
	_ "github.com/openshift/kubernetes/plugin/pkg/scheduler/algorithmprovider"
	schedulerapi "github.com/openshift/kubernetes/plugin/pkg/scheduler/api"
	latestschedulerapi "github.com/openshift/kubernetes/plugin/pkg/scheduler/api/latest"
	"github.com/openshift/kubernetes/plugin/pkg/scheduler/factory"
