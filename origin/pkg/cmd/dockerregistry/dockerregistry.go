...
import (
	...
	log "github.com/openshift/github.com/Sirupsen/logrus"
	gorillahandlers "github.com/openshift/github.com/gorilla/handlers"

	"github.com/openshift/github.com/Sirupsen/logrus/formatters/logstash"
	"github.com/openshift/github.com/docker/distribution/configuration"
	"github.com/openshift/github.com/docker/distribution/context"
	"github.com/openshift/github.com/docker/distribution/health"
	"github.com/openshift/github.com/docker/distribution/reference"
	"github.com/openshift/github.com/docker/distribution/registry/auth"
	"github.com/openshift/github.com/docker/distribution/registry/handlers"
	"github.com/openshift/github.com/docker/distribution/uuid"
	"github.com/openshift/github.com/docker/distribution/version"

	_ "github.com/openshift/github.com/docker/distribution/registry/auth/htpasswd"
	_ "github.com/openshift/github.com/docker/distribution/registry/auth/token"

	_ "github.com/openshift/github.com/docker/distribution/registry/proxy"
	_ "github.com/openshift/github.com/docker/distribution/registry/storage/driver/azure"
	_ "github.com/openshift/github.com/docker/distribution/registry/storage/driver/filesystem"
	_ "github.com/openshift/github.com/docker/distribution/registry/storage/driver/gcs"
	_ "github.com/openshift/github.com/docker/distribution/registry/storage/driver/inmemory"
	_ "github.com/openshift/github.com/docker/distribution/registry/storage/driver/middleware/cloudfront"
	_ "github.com/openshift/github.com/docker/distribution/registry/storage/driver/oss"
	_ "github.com/openshift/github.com/docker/distribution/registry/storage/driver/s3-aws"
	_ "github.com/openshift/github.com/docker/distribution/registry/storage/driver/swift"
