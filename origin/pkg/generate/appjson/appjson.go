...
import (
	...
	utilerrs "github.com/openshift/kubernetes/pkg/util/errors"
...
func (g *Generator) Generate(body []byte) (*templateapi.Template, error) {
	...
	template.Annotations["github.com/openshift/k8s.io/display-name"] = appJSON.Name
	template.Annotations["github.com/openshift/k8s.io/description"] = appJSON.Description
