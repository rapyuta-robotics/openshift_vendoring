...
import (
	v1 "github.com/openshift/origin/pkg/sdn/client/clientset_generated/release_v1_5/typed/core/v1"
...
func (c *FakeCoreV1) ClusterNetworks(namespace string) v1.ClusterNetworkInterface {
