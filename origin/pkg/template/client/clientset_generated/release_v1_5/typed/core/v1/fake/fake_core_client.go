...
import (
	v1 "github.com/openshift/origin/pkg/template/client/clientset_generated/release_v1_5/typed/core/v1"
...
func (c *FakeCoreV1) Templates(namespace string) v1.TemplateInterface {
