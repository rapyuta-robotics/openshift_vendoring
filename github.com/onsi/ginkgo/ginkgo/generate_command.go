...
import (
	...
	{{if .IncludeImports}}. "github.com/openshift/github.com/onsi/ginkgo"{{end}}
	{{if .IncludeImports}}. "github.com/openshift/github.com/onsi/gomega"{{end}}
)
...
import (
	...
	{{if .IncludeImports}}. "github.com/openshift/github.com/onsi/ginkgo"{{end}}
	{{if .IncludeImports}}. "github.com/openshift/github.com/onsi/gomega"{{end}}
	. "github.com/openshift/github.com/sclevine/agouti/matchers"
