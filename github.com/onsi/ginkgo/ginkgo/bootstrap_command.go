...
import (
	...
	"github.com/openshift/github.com/onsi/ginkgo/ginkgo/nodot"
)
...
import (
	{{.GinkgoImport}}
	{{.GomegaImport}}
	"github.com/openshift/github.com/sclevine/agouti"
...
func generateBootstrap(agouti, noDot, internal bool) {
	...
	data := bootstrapData{
		...
		GinkgoImport:  `. "github.com/openshift/github.com/onsi/ginkgo"`,
		GomegaImport:  `. "github.com/openshift/github.com/onsi/gomega"`,
	}

	if noDot {
		data.GinkgoImport = `"github.com/openshift/github.com/onsi/ginkgo"`
		data.GomegaImport = `"github.com/openshift/github.com/onsi/gomega"`
	}
