...
import (
	...
	pioutil "github.com/openshift/github.com/coreos/etcd/pkg/ioutil"
	...
	"github.com/openshift/github.com/coreos/etcd/snap/snappb"
...
var (
	plog = capnslog.NewPackageLogger("github.com/openshift/github.com/coreos/etcd", "snap")
