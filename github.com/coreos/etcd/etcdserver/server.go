...
import (
	...
	"github.com/openshift/github.com/coreos/etcd/alarm"
	"github.com/openshift/github.com/coreos/etcd/auth"
	"github.com/openshift/github.com/coreos/etcd/compactor"
	"github.com/openshift/github.com/coreos/etcd/discovery"
	"github.com/openshift/github.com/coreos/etcd/etcdserver/api"
	"github.com/openshift/github.com/coreos/etcd/etcdserver/api/v2http/httptypes"
	pb "github.com/openshift/github.com/coreos/etcd/etcdserver/etcdserverpb"
	"github.com/openshift/github.com/coreos/etcd/etcdserver/membership"
	"github.com/openshift/github.com/coreos/etcd/etcdserver/stats"
	"github.com/openshift/github.com/coreos/etcd/lease"
	"github.com/openshift/github.com/coreos/etcd/mvcc"
	"github.com/openshift/github.com/coreos/etcd/mvcc/backend"
	"github.com/openshift/github.com/coreos/etcd/pkg/contention"
	"github.com/openshift/github.com/coreos/etcd/pkg/fileutil"
	"github.com/openshift/github.com/coreos/etcd/pkg/idutil"
	"github.com/openshift/github.com/coreos/etcd/pkg/pbutil"
	"github.com/openshift/github.com/coreos/etcd/pkg/runtime"
	"github.com/openshift/github.com/coreos/etcd/pkg/schedule"
	"github.com/openshift/github.com/coreos/etcd/pkg/types"
	"github.com/openshift/github.com/coreos/etcd/pkg/wait"
	"github.com/openshift/github.com/coreos/etcd/raft"
	"github.com/openshift/github.com/coreos/etcd/raft/raftpb"
	"github.com/openshift/github.com/coreos/etcd/rafthttp"
	"github.com/openshift/github.com/coreos/etcd/snap"
	"github.com/openshift/github.com/coreos/etcd/store"
	"github.com/openshift/github.com/coreos/etcd/version"
	"github.com/openshift/github.com/coreos/etcd/wal"
	"github.com/openshift/github.com/coreos/go-semver/semver"
	"github.com/openshift/github.com/coreos/pkg/capnslog"
...
var (
	plog = capnslog.NewPackageLogger("github.com/openshift/github.com/coreos/etcd", "etcdserver")
