...
import (
	...
	"github.com/openshift/github.com/coreos/etcd/etcdserver/api/v2http"
	"github.com/openshift/github.com/coreos/etcd/etcdserver/api/v3rpc"
	pb "github.com/openshift/github.com/coreos/etcd/etcdserver/etcdserverpb"
	"github.com/openshift/github.com/coreos/etcd/pkg/testutil"
	"github.com/openshift/github.com/coreos/etcd/pkg/transport"
...
var (
	...
	plog = capnslog.NewPackageLogger("github.com/openshift/github.com/coreos/etcd", "integration")
)
