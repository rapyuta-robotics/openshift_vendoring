...
import (
	...
	"github.com/openshift/github.com/docker/distribution"
	"github.com/openshift/github.com/docker/distribution/configuration"
	ctxu "github.com/openshift/github.com/docker/distribution/context"
	"github.com/openshift/github.com/docker/distribution/health"
	"github.com/openshift/github.com/docker/distribution/health/checks"
	"github.com/openshift/github.com/docker/distribution/notifications"
	"github.com/openshift/github.com/docker/distribution/reference"
	"github.com/openshift/github.com/docker/distribution/registry/api/errcode"
	"github.com/openshift/github.com/docker/distribution/registry/api/v2"
	"github.com/openshift/github.com/docker/distribution/registry/auth"
	registrymiddleware "github.com/openshift/github.com/docker/distribution/registry/middleware/registry"
	repositorymiddleware "github.com/openshift/github.com/docker/distribution/registry/middleware/repository"
	"github.com/openshift/github.com/docker/distribution/registry/proxy"
	"github.com/openshift/github.com/docker/distribution/registry/storage"
	memorycache "github.com/openshift/github.com/docker/distribution/registry/storage/cache/memory"
	rediscache "github.com/openshift/github.com/docker/distribution/registry/storage/cache/redis"
	storagedriver "github.com/openshift/github.com/docker/distribution/registry/storage/driver"
	"github.com/openshift/github.com/docker/distribution/registry/storage/driver/factory"
	storagemiddleware "github.com/openshift/github.com/docker/distribution/registry/storage/driver/middleware"
