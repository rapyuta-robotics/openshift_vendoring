...
`import "github.com/openshift/github.com/influxdata/influxdb/client/v2"`. It is not backwards-compatible.
...
import (
	...
	"github.com/openshift/github.com/influxdata/influxdb/client/v2"
)
