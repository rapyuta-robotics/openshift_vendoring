...
import (
	...
	"github.com/openshift/golang.org/x/text/internal/tag"
	"github.com/openshift/golang.org/x/text/unicode/cldr"
)
...
func main() {
	...
	fmt.Fprintln(w, `import "github.com/openshift/golang.org/x/text/internal/tag"`)
