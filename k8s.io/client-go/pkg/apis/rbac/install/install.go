...
import (
	...
	"github.com/openshift/k8s.io/client-go/pkg/apis/rbac"
	"github.com/openshift/k8s.io/client-go/pkg/apis/rbac/v1alpha1"
...
func init() {
	if err := announced.NewGroupMetaFactory(
		&announced.GroupMetaFactoryArgs{
			...
			ImportPrefix:               "github.com/openshift/k8s.io/client-go/pkg/apis/rbac",
