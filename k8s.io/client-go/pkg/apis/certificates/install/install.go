...
import (
	...
	"github.com/openshift/k8s.io/client-go/pkg/apis/certificates"
	"github.com/openshift/k8s.io/client-go/pkg/apis/certificates/v1alpha1"
...
func init() {
	if err := announced.NewGroupMetaFactory(
		&announced.GroupMetaFactoryArgs{
			...
			ImportPrefix:               "github.com/openshift/k8s.io/client-go/pkg/apis/certificates",
