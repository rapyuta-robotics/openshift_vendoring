...
import (
	...
	"github.com/openshift/k8s.io/client-go/pkg/apis/batch/v1"
	"github.com/openshift/k8s.io/client-go/pkg/apis/batch/v2alpha1"
)
...
func init() {
	if err := announced.NewGroupMetaFactory(
		&announced.GroupMetaFactoryArgs{
			...
			ImportPrefix:               "github.com/openshift/k8s.io/client-go/pkg/apis/batch",
