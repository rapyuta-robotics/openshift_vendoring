...
import (
	...
	discovery "github.com/openshift/k8s.io/client-go/discovery"
	v1beta1apps "github.com/openshift/k8s.io/client-go/kubernetes/typed/apps/v1beta1"
	v1beta1authentication "github.com/openshift/k8s.io/client-go/kubernetes/typed/authentication/v1beta1"
	v1beta1authorization "github.com/openshift/k8s.io/client-go/kubernetes/typed/authorization/v1beta1"
	v1autoscaling "github.com/openshift/k8s.io/client-go/kubernetes/typed/autoscaling/v1"
	v1batch "github.com/openshift/k8s.io/client-go/kubernetes/typed/batch/v1"
	v2alpha1batch "github.com/openshift/k8s.io/client-go/kubernetes/typed/batch/v2alpha1"
	v1alpha1certificates "github.com/openshift/k8s.io/client-go/kubernetes/typed/certificates/v1alpha1"
	v1core "github.com/openshift/k8s.io/client-go/kubernetes/typed/core/v1"
	v1beta1extensions "github.com/openshift/k8s.io/client-go/kubernetes/typed/extensions/v1beta1"
	v1beta1policy "github.com/openshift/k8s.io/client-go/kubernetes/typed/policy/v1beta1"
	v1alpha1rbac "github.com/openshift/k8s.io/client-go/kubernetes/typed/rbac/v1alpha1"
	v1beta1storage "github.com/openshift/k8s.io/client-go/kubernetes/typed/storage/v1beta1"
	"github.com/openshift/k8s.io/client-go/pkg/util/flowcontrol"
	_ "github.com/openshift/k8s.io/client-go/plugin/pkg/client/auth"
