...
import (
	...
	staging "github.com/openshift/k8s.io/client-go/kubernetes"
	"github.com/openshift/k8s.io/client-go/pkg/util/sets"
	clientreporestclient "github.com/openshift/k8s.io/client-go/rest"
	...
	"github.com/openshift/kubernetes/pkg/metrics"
	...
	yaml "github.com/openshift/gopkg.in/yaml.v2"
)
