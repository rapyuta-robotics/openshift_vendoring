...
import (
	...
	"github.com/openshift/k8s.io/client-go/kubernetes"
	"github.com/openshift/k8s.io/client-go/pkg/api/unversioned"
	api "github.com/openshift/k8s.io/client-go/pkg/api/v1"
	extensions "github.com/openshift/k8s.io/client-go/pkg/apis/extensions/v1beta1"
	policy "github.com/openshift/k8s.io/client-go/pkg/apis/policy/v1beta1"
