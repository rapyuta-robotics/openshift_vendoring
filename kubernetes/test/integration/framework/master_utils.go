...
import (
	...
	"github.com/openshift/kubernetes/pkg/apis/policy"
	"github.com/openshift/kubernetes/pkg/apis/rbac"
	"github.com/openshift/kubernetes/pkg/apis/storage"
	"github.com/openshift/kubernetes/pkg/apiserver/authenticator"
	authauthenticator "github.com/openshift/kubernetes/pkg/auth/authenticator"
	authauthorizer "github.com/openshift/kubernetes/pkg/auth/authorizer"
	authorizerunion "github.com/openshift/kubernetes/pkg/auth/authorizer/union"
	...
	coreclient "github.com/openshift/kubernetes/pkg/client/clientset_generated/release_1_5/typed/core/v1"
	...
	"github.com/openshift/kubernetes/pkg/generated/openapi"
	"github.com/openshift/kubernetes/pkg/genericapiserver"
	"github.com/openshift/kubernetes/pkg/genericapiserver/authorizer"
	...
	"github.com/openshift/kubernetes/plugin/pkg/admission/admit"
	authenticatorunion "github.com/openshift/kubernetes/plugin/pkg/auth/authenticator/request/union"

	"github.com/openshift/github.com/go-openapi/spec"
	"github.com/openshift/github.com/pborman/uuid"
)
