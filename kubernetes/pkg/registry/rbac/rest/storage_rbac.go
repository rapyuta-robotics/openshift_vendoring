...
import (
	...
	rbacapiv1alpha1 "github.com/openshift/kubernetes/pkg/apis/rbac/v1alpha1"
	rbacvalidation "github.com/openshift/kubernetes/pkg/apis/rbac/validation"
	rbacclient "github.com/openshift/kubernetes/pkg/client/clientset_generated/internalclientset/typed/rbac/internalversion"
	"github.com/openshift/kubernetes/pkg/genericapiserver"
	"github.com/openshift/kubernetes/pkg/registry/rbac/clusterrole"
	clusterroleetcd "github.com/openshift/kubernetes/pkg/registry/rbac/clusterrole/etcd"
	clusterrolepolicybased "github.com/openshift/kubernetes/pkg/registry/rbac/clusterrole/policybased"
	"github.com/openshift/kubernetes/pkg/registry/rbac/clusterrolebinding"
	clusterrolebindingetcd "github.com/openshift/kubernetes/pkg/registry/rbac/clusterrolebinding/etcd"
	clusterrolebindingpolicybased "github.com/openshift/kubernetes/pkg/registry/rbac/clusterrolebinding/policybased"
	"github.com/openshift/kubernetes/pkg/registry/rbac/role"
	roleetcd "github.com/openshift/kubernetes/pkg/registry/rbac/role/etcd"
	rolepolicybased "github.com/openshift/kubernetes/pkg/registry/rbac/role/policybased"
	"github.com/openshift/kubernetes/pkg/registry/rbac/rolebinding"
	rolebindingetcd "github.com/openshift/kubernetes/pkg/registry/rbac/rolebinding/etcd"
	rolebindingpolicybased "github.com/openshift/kubernetes/pkg/registry/rbac/rolebinding/policybased"
	utilruntime "github.com/openshift/kubernetes/pkg/util/runtime"
	"github.com/openshift/kubernetes/plugin/pkg/auth/authorizer/rbac/bootstrappolicy"
)
