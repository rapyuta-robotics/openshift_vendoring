...
import (
	...
	"github.com/openshift/kubernetes/plugin/pkg/auth/authenticator/password/keystone"
	"github.com/openshift/kubernetes/plugin/pkg/auth/authenticator/password/passwordfile"
	"github.com/openshift/kubernetes/plugin/pkg/auth/authenticator/request/anonymous"
	"github.com/openshift/kubernetes/plugin/pkg/auth/authenticator/request/basicauth"
	"github.com/openshift/kubernetes/plugin/pkg/auth/authenticator/request/headerrequest"
	"github.com/openshift/kubernetes/plugin/pkg/auth/authenticator/request/union"
	"github.com/openshift/kubernetes/plugin/pkg/auth/authenticator/request/x509"
	"github.com/openshift/kubernetes/plugin/pkg/auth/authenticator/token/anytoken"
	"github.com/openshift/kubernetes/plugin/pkg/auth/authenticator/token/oidc"
	"github.com/openshift/kubernetes/plugin/pkg/auth/authenticator/token/tokenfile"
	"github.com/openshift/kubernetes/plugin/pkg/auth/authenticator/token/webhook"
)
