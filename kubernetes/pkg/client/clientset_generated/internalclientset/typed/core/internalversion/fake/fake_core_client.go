...
import (
	internalversion "github.com/openshift/kubernetes/pkg/client/clientset_generated/internalclientset/typed/core/internalversion"
...
func (c *FakeCore) SecurityContextConstraints() internalversion.SecurityContextConstraintsInterface {
