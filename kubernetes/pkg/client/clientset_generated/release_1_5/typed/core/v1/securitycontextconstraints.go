...
type SecurityContextConstraintsInterface interface {
	...
	List(opts v1.ListOptions) (*v1.SecurityContextConstraintsList, error)
...
func (c *securityContextConstraints) List(opts v1.ListOptions) (result *v1.SecurityContextConstraintsList, err error) {
