...
import (
	...
	cmdconfig "github.com/openshift/kubernetes/pkg/kubectl/cmd/config"
	"github.com/openshift/kubernetes/pkg/kubectl/cmd/rollout"
	"github.com/openshift/kubernetes/pkg/kubectl/cmd/set"
	"github.com/openshift/kubernetes/pkg/kubectl/cmd/templates"
	cmdutil "github.com/openshift/kubernetes/pkg/kubectl/cmd/util"
	"github.com/openshift/kubernetes/pkg/util/flag"
