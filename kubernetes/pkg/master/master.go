...
import (
	...
	appsapi "github.com/openshift/kubernetes/pkg/apis/apps/v1beta1"
	authenticationv1beta1 "github.com/openshift/kubernetes/pkg/apis/authentication/v1beta1"
	authorizationapiv1beta1 "github.com/openshift/kubernetes/pkg/apis/authorization/v1beta1"
	autoscalingapiv1 "github.com/openshift/kubernetes/pkg/apis/autoscaling/v1"
	batchapiv1 "github.com/openshift/kubernetes/pkg/apis/batch/v1"
	certificatesapiv1alpha1 "github.com/openshift/kubernetes/pkg/apis/certificates/v1alpha1"
	extensionsapiv1beta1 "github.com/openshift/kubernetes/pkg/apis/extensions/v1beta1"
	policyapiv1beta1 "github.com/openshift/kubernetes/pkg/apis/policy/v1beta1"
	rbacapi "github.com/openshift/kubernetes/pkg/apis/rbac/v1alpha1"
	storageapiv1beta1 "github.com/openshift/kubernetes/pkg/apis/storage/v1beta1"
	...
	"github.com/openshift/kubernetes/pkg/genericapiserver/options"
	"github.com/openshift/kubernetes/pkg/healthz"
	kubeletclient "github.com/openshift/kubernetes/pkg/kubelet/client"
	"github.com/openshift/kubernetes/pkg/master/thirdparty"
	...
	"github.com/openshift/kubernetes/pkg/routes"

	"github.com/golang/glog"
	"github.com/openshift/github.com/prometheus/client_golang/prometheus"

	// RESTStorage installers
	appsrest "github.com/openshift/kubernetes/pkg/registry/apps/rest"
	authenticationrest "github.com/openshift/kubernetes/pkg/registry/authentication/rest"
	authorizationrest "github.com/openshift/kubernetes/pkg/registry/authorization/rest"
	autoscalingrest "github.com/openshift/kubernetes/pkg/registry/autoscaling/rest"
	batchrest "github.com/openshift/kubernetes/pkg/registry/batch/rest"
	certificatesrest "github.com/openshift/kubernetes/pkg/registry/certificates/rest"
	corerest "github.com/openshift/kubernetes/pkg/registry/core/rest"
	extensionsrest "github.com/openshift/kubernetes/pkg/registry/extensions/rest"
	policyrest "github.com/openshift/kubernetes/pkg/registry/policy/rest"
	rbacrest "github.com/openshift/kubernetes/pkg/registry/rbac/rest"
	storagerest "github.com/openshift/kubernetes/pkg/registry/storage/rest"
)
