...
import (
	...
	componentconfigv1alpha1 "github.com/openshift/kubernetes/pkg/apis/componentconfig/v1alpha1"
	...
	"github.com/openshift/kubernetes/pkg/kubelet/cm"
	"github.com/openshift/kubernetes/pkg/kubelet/config"
	kubecontainer "github.com/openshift/kubernetes/pkg/kubelet/container"
	"github.com/openshift/kubernetes/pkg/kubelet/dockershim"
	dockerremote "github.com/openshift/kubernetes/pkg/kubelet/dockershim/remote"
	"github.com/openshift/kubernetes/pkg/kubelet/dockertools"
	"github.com/openshift/kubernetes/pkg/kubelet/events"
	"github.com/openshift/kubernetes/pkg/kubelet/eviction"
	"github.com/openshift/kubernetes/pkg/kubelet/images"
	"github.com/openshift/kubernetes/pkg/kubelet/kuberuntime"
	"github.com/openshift/kubernetes/pkg/kubelet/lifecycle"
	"github.com/openshift/kubernetes/pkg/kubelet/metrics"
	"github.com/openshift/kubernetes/pkg/kubelet/network"
	"github.com/openshift/kubernetes/pkg/kubelet/pleg"
	kubepod "github.com/openshift/kubernetes/pkg/kubelet/pod"
	"github.com/openshift/kubernetes/pkg/kubelet/prober"
	proberesults "github.com/openshift/kubernetes/pkg/kubelet/prober/results"
	"github.com/openshift/kubernetes/pkg/kubelet/remote"
	"github.com/openshift/kubernetes/pkg/kubelet/rkt"
	"github.com/openshift/kubernetes/pkg/kubelet/server"
	"github.com/openshift/kubernetes/pkg/kubelet/server/stats"
	"github.com/openshift/kubernetes/pkg/kubelet/server/streaming"
	"github.com/openshift/kubernetes/pkg/kubelet/status"
	"github.com/openshift/kubernetes/pkg/kubelet/sysctl"
	kubetypes "github.com/openshift/kubernetes/pkg/kubelet/types"
	"github.com/openshift/kubernetes/pkg/kubelet/util/format"
	"github.com/openshift/kubernetes/pkg/kubelet/util/queue"
	"github.com/openshift/kubernetes/pkg/kubelet/util/sliceutils"
	"github.com/openshift/kubernetes/pkg/kubelet/volumemanager"
	...
	"github.com/openshift/kubernetes/pkg/util/bandwidth"
	"github.com/openshift/kubernetes/pkg/util/clock"
	utilconfig "github.com/openshift/kubernetes/pkg/util/config"
	utildbus "github.com/openshift/kubernetes/pkg/util/dbus"
	utilexec "github.com/openshift/kubernetes/pkg/util/exec"
	"github.com/openshift/kubernetes/pkg/util/flowcontrol"
	"github.com/openshift/kubernetes/pkg/util/integer"
	kubeio "github.com/openshift/kubernetes/pkg/util/io"
	utilipt "github.com/openshift/kubernetes/pkg/util/iptables"
	"github.com/openshift/kubernetes/pkg/util/mount"
	nodeutil "github.com/openshift/kubernetes/pkg/util/node"
	...
	"github.com/openshift/kubernetes/plugin/pkg/scheduler/algorithm/predicates"
)
