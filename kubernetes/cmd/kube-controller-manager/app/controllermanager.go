...
import (
	...
	"github.com/openshift/kubernetes/cmd/kube-controller-manager/app/options"
	...
	"github.com/openshift/kubernetes/pkg/client/leaderelection"
	"github.com/openshift/kubernetes/pkg/client/leaderelection/resourcelock"
	...
	certcontroller "github.com/openshift/kubernetes/pkg/controller/certificates"
	"github.com/openshift/kubernetes/pkg/controller/cronjob"
	"github.com/openshift/kubernetes/pkg/controller/daemon"
	"github.com/openshift/kubernetes/pkg/controller/deployment"
	"github.com/openshift/kubernetes/pkg/controller/disruption"
	endpointcontroller "github.com/openshift/kubernetes/pkg/controller/endpoint"
	"github.com/openshift/kubernetes/pkg/controller/garbagecollector"
	"github.com/openshift/kubernetes/pkg/controller/garbagecollector/metaonly"
	"github.com/openshift/kubernetes/pkg/controller/informers"
	"github.com/openshift/kubernetes/pkg/controller/job"
	namespacecontroller "github.com/openshift/kubernetes/pkg/controller/namespace"
	nodecontroller "github.com/openshift/kubernetes/pkg/controller/node"
	petset "github.com/openshift/kubernetes/pkg/controller/petset"
	"github.com/openshift/kubernetes/pkg/controller/podautoscaler"
	"github.com/openshift/kubernetes/pkg/controller/podautoscaler/metrics"
	"github.com/openshift/kubernetes/pkg/controller/podgc"
	replicaset "github.com/openshift/kubernetes/pkg/controller/replicaset"
	replicationcontroller "github.com/openshift/kubernetes/pkg/controller/replication"
	resourcequotacontroller "github.com/openshift/kubernetes/pkg/controller/resourcequota"
	routecontroller "github.com/openshift/kubernetes/pkg/controller/route"
	servicecontroller "github.com/openshift/kubernetes/pkg/controller/service"
	serviceaccountcontroller "github.com/openshift/kubernetes/pkg/controller/serviceaccount"
	"github.com/openshift/kubernetes/pkg/controller/volume/attachdetach"
	persistentvolumecontroller "github.com/openshift/kubernetes/pkg/controller/volume/persistentvolume"
	"github.com/openshift/kubernetes/pkg/healthz"
	quotainstall "github.com/openshift/kubernetes/pkg/quota/install"
	"github.com/openshift/kubernetes/pkg/runtime/serializer"
	"github.com/openshift/kubernetes/pkg/serviceaccount"
	certutil "github.com/openshift/kubernetes/pkg/util/cert"
	"github.com/openshift/kubernetes/pkg/util/configz"
	"github.com/openshift/kubernetes/pkg/util/wait"

	"github.com/golang/glog"
	"github.com/openshift/github.com/prometheus/client_golang/prometheus"
