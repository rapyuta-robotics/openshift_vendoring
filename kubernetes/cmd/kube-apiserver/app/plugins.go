...
import (
	...
	_ "github.com/openshift/kubernetes/plugin/pkg/admission/antiaffinity"
	_ "github.com/openshift/kubernetes/plugin/pkg/admission/deny"
	_ "github.com/openshift/kubernetes/plugin/pkg/admission/exec"
	_ "github.com/openshift/kubernetes/plugin/pkg/admission/gc"
	_ "github.com/openshift/kubernetes/plugin/pkg/admission/imagepolicy"
	_ "github.com/openshift/kubernetes/plugin/pkg/admission/initialresources"
	_ "github.com/openshift/kubernetes/plugin/pkg/admission/limitranger"
	_ "github.com/openshift/kubernetes/plugin/pkg/admission/namespace/autoprovision"
	...
	_ "github.com/openshift/kubernetes/plugin/pkg/admission/security/podsecuritypolicy"
	_ "github.com/openshift/kubernetes/plugin/pkg/admission/securitycontext/scdeny"
	_ "github.com/openshift/kubernetes/plugin/pkg/admission/serviceaccount"
	_ "github.com/openshift/kubernetes/plugin/pkg/admission/storageclass/default"
)
