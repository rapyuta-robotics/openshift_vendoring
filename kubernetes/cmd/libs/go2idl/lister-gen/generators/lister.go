...
func isInternal(t *types.Type) bool {
	return t.Name.Package == "github.com/openshift/kubernetes/pkg/api"
}
...
func (g *listerGenerator) Imports(c *generator.Context) (imports []string) {
	...
	imports = append(imports, "github.com/openshift/kubernetes/pkg/api/errors")
	imports = append(imports, "github.com/openshift/kubernetes/pkg/labels")
	// for Indexer
	imports = append(imports, "github.com/openshift/kubernetes/pkg/client/cache")
	return
}
