...
func (g *genGroup) GenerateType(c *generator.Context, t *types.Type, w io.Writer) error {
	...
	const pkgRESTClient = "github.com/openshift/kubernetes/pkg/client/restclient"
	const pkgRegistered = "github.com/openshift/kubernetes/pkg/apimachinery/registered"
	const pkgAPI = "github.com/openshift/kubernetes/pkg/api"
	const pkgSerializer = "github.com/openshift/kubernetes/pkg/runtime/serializer"
	const pkgUnversioned = "github.com/openshift/kubernetes/pkg/api/unversioned"
