...
func (g *genFakeForType) GenerateType(c *generator.Context, t *types.Type, w io.Writer) error {
	...
	const pkgTestingCore = "github.com/openshift/kubernetes/pkg/client/testing/core"
	...
	m := map[string]interface{}{
		...
		"groupName":            groupName,
		"version":              g.version,
		"watchInterface":       c.Universe.Type(types.Name{Package: "github.com/openshift/kubernetes/pkg/watch", Name: "Interface"}),
		"GroupVersionResource": c.Universe.Type(types.Name{Package: "github.com/openshift/kubernetes/pkg/api/unversioned", Name: "GroupVersionResource"}),
		"PatchType":            c.Universe.Type(types.Name{Package: "github.com/openshift/kubernetes/pkg/api", Name: "PatchType"}),
		"Everything":           c.Universe.Function(types.Name{Package: "github.com/openshift/kubernetes/pkg/labels", Name: "Everything"}),
	...
	if g.version == "" {
		m["DeleteOptions"] = c.Universe.Type(types.Name{Package: "github.com/openshift/kubernetes/pkg/api", Name: "DeleteOptions"})
		m["ListOptions"] = c.Universe.Type(types.Name{Package: "github.com/openshift/kubernetes/pkg/api", Name: "ListOptions"})
	} else {
		m["DeleteOptions"] = c.Universe.Type(types.Name{Package: "github.com/openshift/kubernetes/pkg/api/v1", Name: "DeleteOptions"})
		m["ListOptions"] = c.Universe.Type(types.Name{Package: "github.com/openshift/kubernetes/pkg/api/v1", Name: "ListOptions"})
	}
