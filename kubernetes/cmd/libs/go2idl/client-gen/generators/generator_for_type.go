...
func (g *genClientForType) GenerateType(c *generator.Context, t *types.Type, w io.Writer) error {
	...
	m := map[string]interface{}{
		...
		"RESTClientInterface": c.Universe.Type(types.Name{Package: "github.com/openshift/kubernetes/pkg/client/restclient", Name: "Interface"}),
		"apiParameterCodec":   c.Universe.Type(types.Name{Package: "github.com/openshift/kubernetes/pkg/api", Name: "ParameterCodec"}),
