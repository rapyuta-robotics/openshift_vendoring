...
func (g *genClientset) Imports(c *generator.Context) (imports []string) {
	...
	imports = append(imports, "github.com/openshift/kubernetes/pkg/util/flowcontrol")
	// import solely to initialize client auth plugins.
	imports = append(imports, "_ \"github.com/openshift/kubernetes/plugin/pkg/client/auth\"")
	return
}
...
func (g *genClientset) GenerateType(c *generator.Context, t *types.Type, w io.Writer) error {
	...
	const pkgDiscovery = "github.com/openshift/kubernetes/pkg/client/typed/discovery"
