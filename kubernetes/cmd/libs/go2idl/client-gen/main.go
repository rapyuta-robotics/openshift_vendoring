...
import (
	...
	clientgenargs "github.com/openshift/kubernetes/cmd/libs/go2idl/client-gen/args"
	"github.com/openshift/kubernetes/cmd/libs/go2idl/client-gen/generators"
	"github.com/openshift/kubernetes/cmd/libs/go2idl/client-gen/types"
...
var (
	...
	basePath               = flag.String("input-base", "github.com/openshift/kubernetes/pkg/apis", "base path to look for the api group. Default to \"github.com/openshift/kubernetes/pkg/apis\"")
	...
	clientsetPath          = flag.String("clientset-path", "github.com/openshift/kubernetes/pkg/client/clientset_generated/", "the generated clientset will be output to <clientset-path>/<clientset-name>. Default to \"github.com/openshift/kubernetes/pkg/client/clientset_generated/\"")
...
func main() {
	...
	arguments.GoHeaderFilePath = filepath.Join(args.DefaultSourceTree(), "github.com/openshift/kubernetes/hack/boilerplate/boilerplate.go.txt")
	flag.Parse()
	var cmdArgs string
	...
	if *test {
		arguments.InputDirs = append(dependencies, []string{
			"github.com/openshift/kubernetes/cmd/libs/go2idl/client-gen/test_apis/testgroup",
		}...)
		arguments.CustomArgs = clientgenargs.Args{
			...
			GroupVersionToInputPath: map[types.GroupVersion]string{
				types.GroupVersion{Group: "testgroup", Version: ""}: "github.com/openshift/kubernetes/cmd/libs/go2idl/client-gen/test_apis/testgroup",
			},
			ClientsetName:       "test_internalclientset",
			ClientsetOutputPath: "github.com/openshift/kubernetes/cmd/libs/go2idl/client-gen/testoutput/clientset_generated/",
			ClientsetOnly:       false,
			FakeClient:          true,
			CmdArgs:             cmdArgs,
		}
