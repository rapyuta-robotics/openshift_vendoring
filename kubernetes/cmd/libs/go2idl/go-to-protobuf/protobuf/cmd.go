...
import (
	...
	"github.com/openshift/k8s.io/gengo/parser"
...
func New() *Generator {
	...
	common := args.GeneratorArgs{
		...
		GoHeaderFilePath: filepath.Join(sourceTree, "github.com/openshift/kubernetes/hack/boilerplate/boilerplate.go.txt"),
	}
	...
	return &Generator{
		...
		DropEmbeddedFields: "github.com/openshift/kubernetes/pkg/api/unversioned.TypeMeta",
	}
}
